		    ...
		    case 3:        printf("设置本机IP地址\r\n");
			   ...
			   break; 
				 case 6 :  
				                    ...
				                    printf("设置模式\r\n");
				 if(atk_eth_send_cmd((uint8_t *)"at+NProType0=2\r\n",(uint8_t *)"at+RNProType0",5000)==1)  //选择	tcp client
											 {
												  wifi_state_num=7;											 
											 }
			   break;    												 
